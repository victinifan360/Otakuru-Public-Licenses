...
Introduction: Welcome to the Otakuru V1 license. This text tells you what you can, and what not to do with the work, as well as being a guide for its reproduction and distribution.
...
"This work by [AUTHOR], is publicly licensed under Otakuru License Level 1, and has been used with permission”. (the space between brackets, replace it with the author's name).
